...
class AttachDoc extends StatefulWidget {
  const AttachDoc({Key? key}) : super(key: key);

  @override
  State<AttachDoc> createState() => _AttachDocState();
}

class _AttachDocState extends State<AttachDoc> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        controller: userController.expensesDescriptionAttach,
                ...
                Column(
                  children: [
                    ...
                    DropDownCustomWidget(
                      ...
                      useErrorText: true,
                      validator: true,
                      valueDropdown: userController.kindOfDoc,
                      onChanged: (item) => setState(
                        () => userController.kindOfDoc = item,
                      ),
